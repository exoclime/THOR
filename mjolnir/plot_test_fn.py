...
sub.run([f'regrid -i 54 -l 54 {sim_path.__str__()} -w -pgrid pgrid_9_54_1.txt'],shell=True,stdout=sub.DEVNULL)
...
sub.run([f'mjolnir -i 54 -f {sim_path.__str__()} Tver uver Tlonver'],shell=True)
...
sub.run([f'regrid -i 60 -l 60 {sim_path.__str__()} -w -unmask'],shell=True)
