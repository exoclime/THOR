...
// This subroutine follows Parmentier & Guillot (2014, 2015) non-grey picket fence scheme
void Parmentier_IC_1D(const int nlay, double* pl, double Tint, double mu, double Tirr,
    double grav, double* (&Tl), int  table_num, double met) {
    // dependcies
    //// pow -> math    
    //// sqrt -> math
...
void bottum_up_adiabat_correction(int id, int nlay, double* (&Tl), double* pressure_h, double gravity,
    double* Cp, double* Altitude_h, double* Cp_h, double* Rd_h, double P_Ref) {
    // dependcies
