...
__global__ void DivM_Op (double * DivM_d     ,
    ...
    if (laststep)    for (int k = 0; k < 3; k++) a_s[ir * 3 + k] = divg_Mh_d[ig * nv * 3 + lev * 3 + k];
    else{
    ...
    if (x == 0) {
        ...
        if (laststep)    for (int k = 0; k < 3; k++) a_s[ir2 * 3 + k] = divg_Mh_d[ig * nv * 3 + lev * 3 + k];
        else{
    ...
    if (y == 0){
        ...
        for (int k = 0; k < twot; k++){
            ...
            if (ig >= 0){
                ...
                if (laststep)    for (int k = 0; k < 3; k++) a_s[ir2 * 3 + k] = 0.0;
                else{
    ...
    for (int j = 0; j < 6; j++){
        jp1 = ( pent_ind)*(j   == 4 ? 0 : j   + 1) + 
              (!pent_ind)*(j   == 5 ? 0 : j   + 1) ;
        jp2 = ( pent_ind)*(jp1 == 4 ? 0 : jp1 + 1) +
              (!pent_ind)*(jp1 == 5 ? 0 : jp1 + 1);
        ...
        if (j == 0){
            lap1 =(- a01x*nvecti_d[id * 6 * 3 + j   * 3 + 0] - a01y*nvecti_d[id * 6 * 3 + j   * 3 + 1] - a01z*nvecti_d[id * 6 * 3 + j   * 3 + 2]
                   ...
                   + a02x*nvecti_d[id * 6 * 3 + jp1 * 3 + 0] + a02y*nvecti_d[id * 6 * 3 + jp1 * 3 + 1] + a02z*nvecti_d[id * 6 * 3 + jp1 * 3 + 2]) * AT1;
            ...
            lap2 =(- a02x*nvecti_d[id * 6 * 3 + jp1 * 3 + 0] - a02y*nvecti_d[id * 6 * 3 + jp1 * 3 + 1] - a02z*nvecti_d[id * 6 * 3 + jp1 * 3 + 2]
                   ...
                   + a03x*nvecti_d[id * 6 * 3 + jp2 * 3 + 0] + a03y*nvecti_d[id * 6 * 3 + jp2 * 3 + 1] + a03z*nvecti_d[id * 6 * 3 + jp2 * 3 + 2]) * AT2;
        }
        else{
            lap1 = lap2;
            lap2 =(- a02x*nvecti_d[id * 6 * 3 + jp1 * 3 + 0] - a02y*nvecti_d[id * 6 * 3 + jp1 * 3 + 1] - a02z*nvecti_d[id * 6 * 3 + jp1 * 3 + 2]
...
/////////////////////////////////////////
    ...
    if (laststep){
        ...
        for (int i = 1; i < 6; i++) for (int k = 0; k < 3; k++)a_p[i * 3 + k] = divg_Mh_d[local_p[i - 1] * nv * 3 + lev * 3 + k];
    }
    else{
        for (int k = 0; k < 3; k++) a_p[0 * 3 + k] = Mh_d[id * 3 * nv + lev * 3 + k];
        for (int i = 1; i < 6; i++) for (int k = 0; k < 3; k++) a_p[i * 3 + k] = Mh_d[local_p[i - 1] * 3 * nv + lev * 3 + k];
    ...
    for (int k = 0; k < 5; k++){
        ...
        if (k == 0){
            lap1 =  (- a01x*nvecti_p[k   * 3 + 0] - a01y*nvecti_p[k   * 3 + 1] - a01z*nvecti_p[k   * 3 + 2] 
                     ...
                     + a02x*nvecti_p[kp1 * 3 + 0] + a02y*nvecti_p[kp1 * 3 + 1] + a02z*nvecti_p[kp1 * 3 + 2]) * AT1;
            ...
            lap2 =    (- a02x*nvecti_p[kp1 * 3 + 0] - a02y*nvecti_p[kp1 * 3 + 1] - a02z*nvecti_p[kp1 * 3 + 2]
                     ...
                     + a03x*nvecti_p[kp2 * 3 + 0] + a03y*nvecti_p[kp2 * 3 + 1] + a03z*nvecti_p[kp2 * 3 + 2]) * AT2;
        }
        else{
            lap1 = lap2;
