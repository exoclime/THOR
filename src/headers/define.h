...
#define Tstar_default 4520             // Star effective temperature [K]
...
#define Tlow_default 970   // Lower boundary temperature: upward flux coming from the planet's interior
